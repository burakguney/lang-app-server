...
const getCategoryByName = (categoryName: string) => Category.findOne({ name: categoryName });
...
export default { Category, getCategories, getCategoryById, getCategoryByName, createCategory, deleteCategoryById, updateCategoryById }